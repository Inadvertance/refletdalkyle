...
{
    public class StartMenuScreen2 : BaseGameState
    {
        ...
        public StartMenuScreen2(Game game, GameStateManager manager)
            : base(game, manager)
        {
        ...
        protected override void LoadContent()
        {
            ...
            fondMenu = Content.Load<Texture2D>(@"backgrounds\titlescreen2");
