...
{
    public class StartMenuScreen3 : BaseGameState
    {
        ...
        public StartMenuScreen3(Game game, GameStateManager manager)
            : base(game, manager)
        {
        ...
        protected override void LoadContent()
        {
            ...
            fondMenu = Content.Load<Texture2D>(@"backgrounds\titlescreen3");
